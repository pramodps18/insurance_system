    ...
    <div id="wrapper">
        <nav class="navbar navbar-default navbar-cls-top " role="navigation" style="margin-bottom: 0">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.php">S&S INSURANCE</a>
            </div>
...
<?php
	...
	while($row = $result->fetch_assoc()) {
		$images = $row["image"];
?>
			<img class="profile-user-img img-responsive"  width="200px" height="200px" src="<?php echo "../lims/uploads/".$images ?>" alt="User profile picture">
<?php
